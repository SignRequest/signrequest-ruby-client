...
module SignRequestClient
  class InlineResponse201
    ...
    def valid?
      ...
      detail_validator = EnumAttributeValidator.new('String', ['OK'])
    ...
    def detail=(detail)
      ...
      unless validator.valid?(detail)
        fail ArgumentError, 'invalid value for "detail", must be one of #{validator.allowable_values}.'
      end
      @detail = detail
    end
