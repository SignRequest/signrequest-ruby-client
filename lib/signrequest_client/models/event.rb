...
module SignRequestClient
  class Event
    ...
    attr_accessor :callback_status_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'delivered_on')
        self.delivered_on = attributes[:'delivered_on']
      end

      if attributes.has_key?(:'callback_status_code')
        self.callback_status_code = attributes[:'callback_status_code']
      end
